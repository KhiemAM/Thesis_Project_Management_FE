...
export function TopicProposalTabsStatusFilter({ value, setValue }: TopicTabsFilterProps) {
  ...
  return (
    <Box sx={{ width: '100%', ml: 3 }}>
      ...
      >
        ...
        <Tab value="Từ chối" label="Từ chối" icon={<Label color='error'>5</Label>} iconPosition='end'/>
      </Tabs>
    </Box>
  )
}
