...
import { MouseSensor, TouchSensor } from 'src/customLibraries/DndKitSensors'
...
function BoardContent({
  ...
  const findColumnByCardId = (cardId) => orderedColumns.find(column => column?.cards?.map(card => card._id)?.includes(cardId))
